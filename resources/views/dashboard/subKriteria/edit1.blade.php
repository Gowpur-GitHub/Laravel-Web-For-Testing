                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('ukuranLayar')
                                  is-invalid
                              @enderror" id="ukuranLayar" value="{{ old('ukuranLayar', $subkriteria->ukuranLayar) }}"
                                name="ukuranLayar" required>
                            @error('ukuranLayar')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('nUkuranLayar')
                                  is-invalid
                              @enderror" id="nUkuranLayar"
                                value="{{ old('nUkuranLayar', $subkriteria->nUkuranLayar) }}" name="nUkuranLayar"
                                required>
                            @error('nUkuranLayar')
                            <div class="invalid-feedback">
                                {{ $message }}
