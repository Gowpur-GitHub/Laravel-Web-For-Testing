                ...
                <form action="{{ route('data-sub-kriteria5.update', $subkriteria->slug) }}" method="POST"
                    ...
                    <div class="mb-3 row">
                        <label for="responseTime"
                            ...
                            Kriteria</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('responseTime')
                                  is-invalid
                              @enderror" id="responseTime"
                                value="{{ old('responseTime', $subkriteria->responseTime) }}" name="responseTime"
                                required>
                            @error('responseTime')
                    ...
                    <div class="mb-3 row">
                        <label for="nResponseTime"
                            class="col-sm-2 col-form-label text-end fw-semibold text-secondary">Nilai</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('nResponseTime')
                                  is-invalid
                              @enderror" id="nResponseTime"
                                value="{{ old('nResponseTime', $subkriteria->nResponseTime) }}" name="nResponseTime"
                                required>
                            @error('nResponseTime')
                            <div class="invalid-feedback">
                                {{ $message }}
...
<script>
    const responseTime = document.querySelector("#responseTime");
        ...
        responseTime.addEventListener("keyup", () => {
            // let preslug = responseTime.value;
